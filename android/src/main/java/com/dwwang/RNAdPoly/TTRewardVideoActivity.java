...
public class TTRewardVideoActivity extends Activity {
    ...
    private void loadAd(final String codeId, int orientation) {
        ...
        Log.e(TAG, "Callback --> onRewardVideoCached， codeId = " + codeId);
        ...
        mTTAdNative.loadRewardVideoAd(adSlot, new TTAdNative.RewardVideoAdListener() {
            ...
            public void onRewardVideoCached() {
                ...
                mIsLoaded = true;
                // TToast.show(RewardVideoActivity.this, "Callback --> rewardVideoAd video
                // cached");
            }
            ...
            public void onRewardVideoCached(TTRewardVideoAd ad) {
                ...
                // TToast.show(RewardVideoActivity.this, "Callback --> rewardVideoAd video
                // cached");
                ad.showRewardVideoAd(TTRewardVideoActivity.this, TTAdConstant.RitScenes.CUSTOMIZE_SCENES,
                        "scenes_test");
            }
            ...
            public void onRewardVideoAdLoad(TTRewardVideoAd ad) {
                ...
                // TToast.show(RewardVideoActivity.this, "rewardVideoAd loaded 广告类型：" +
